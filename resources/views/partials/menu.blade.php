...
@can('testimonial_access')
    @php
        $testimonialActive = request()->is('admin/testimonials*');
    @endphp
    ...
    <div x-data="{ open: {{ $testimonialActive ? 'true' : 'false' }} }">
        ...
        <button type="button"
                ...
                class="nav-link nav-group-btn {{ $testimonialActive ? 'active' : '' }}">
...
@can('faq_access')
    @php
        $faqActive = request()->is('admin/faqs*');
    @endphp

    <div x-data="{ open: {{ $faqActive ? 'true' : 'false' }} }">

        <button type="button"
                @click="open = !open"
                data-tooltip="FAQs"
                class="nav-link nav-group-btn {{ $faqActive ? 'active' : '' }}">
