...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update gallery image, overlay details and category
        </p>
    </div>
</div>
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="gallery_category_id"
                            ...
                            @foreach($categories as $id => $category)
                                <option value="{{ $id }}" {{ old('gallery_category_id', $galleryItem->gallery_category_id) == $id ? 'selected' : '' }}>
                                    {{ $category }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="card_size"
                            ...
                            <option value="normal" {{ old('card_size', $galleryItem->card_size) == 'normal' ? 'selected' : '' }}>Normal</option>
                            <option value="large" {{ old('card_size', $galleryItem->card_size) == 'large' ? 'selected' : '' }}>Large</option>
                            <option value="tall" {{ old('card_size', $galleryItem->card_size) == 'tall' ? 'selected' : '' }}>Tall</option>
                            <option value="wide" {{ old('card_size', $galleryItem->card_size) == 'wide' ? 'selected' : '' }}>Wide</option>
                        </select>
                    </div>
