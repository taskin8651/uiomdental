...
@section('page-title', 'Create Service Section')
...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Create Service Section</h2>

        <p class="admin-page-subtitle">
            Add a dynamic dental service section with image, buttons and benefit cards
        </p>
    </div>
</div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <select name="layout_type"
                            ...
                            <option value="image_left" {{ old('layout_type', 'image_left') == 'image_left' ? 'selected' : '' }}>
                                Image Left
                            </option>
                            <option value="image_right" {{ old('layout_type') == 'image_right' ? 'selected' : '' }}>
                                Image Right
                            </option>
                        </select>
                    </div>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="button_1_icon"
                               value="{{ old('button_1_icon', 'fa-solid fa-calendar-check') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="button_2_icon"
                               value="{{ old('button_2_icon', 'fa-solid fa-phone-volume') }}"
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="float_icon"
                               value="{{ old('float_icon', 'fa-solid fa-user-doctor') }}"
