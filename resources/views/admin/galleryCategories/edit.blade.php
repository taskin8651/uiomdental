...
<div class="admin-page-head">
    <div>
        ...
        <h2 class="admin-page-title">Edit Gallery Category</h2>

        <p class="admin-page-subtitle">
            Update gallery category tab details
        </p>
    </div>
</div>
...
<form method="POST" action="{{ route('admin.gallery-categories.update', $galleryCategory->id) }}">
                ...
                <div class="field-group">
                    <label class="switch-line big">
                        <input type="checkbox"
                               name="status"
                               value="1"
                               {{ old('status', $galleryCategory->status) ? 'checked' : '' }}>
    ...
    <div class="form-actions">
        ...
        <a href="{{ route('admin.gallery-categories.index') }}" class="btn-ghost">
            {{ trans('global.cancel') }}
        </a>
    </div>
