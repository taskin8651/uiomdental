...
<div class="admin-page-head">
    <div>
        ...
        <p class="admin-page-subtitle">
            Update patient review content and frontend visibility
        </p>
    </div>
</div>
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="customer_type"
                               id="customer_type"
                               value="{{ old('customer_type', $testimonial->customer_type) }}"
                ...
                <div class="field-group">
                    ...
                    <textarea name="review_text"
                              ...
                              class="field-textarea {{ $errors->has('review_text') ? 'error' : '' }}">{{ old('review_text', $testimonial->review_text) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <div class="input-icon-wrap">
                        ...
                        <input type="text"
                               name="avatar_letter"
                               id="avatar_letter"
                               value="{{ old('avatar_letter', $testimonial->avatar_letter) }}"
                               placeholder="R"
